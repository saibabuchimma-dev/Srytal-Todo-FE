...
export const TasksPage = lazy(
  () => import('@/features/task/screens/TasksPage'),
);
...
export const ProjectsPage = lazy(() =>
  import('@/features/project/screens/ProjectsPage').then((m) => ({
    default: m.default,
  })),
);
...
export const ProfilePage = lazy(
  () => import('@/features/profile/screens/ProfilePage'),
);

export const SettingsPage = lazy(
  () => import('@/features/settings/screens/SettingsPage'),
);

export const MyTasksPage = lazy(
  () => import('@/features/task/screens/MyTasksPage'),
);
...
export const TaskBoardPage = lazy(
  () => import('@/features/task/screens/TaskBoardPage'),
);

export const ReportsPage = lazy(
  () => import('@/features/report/screens/ReportsPage'),
);
