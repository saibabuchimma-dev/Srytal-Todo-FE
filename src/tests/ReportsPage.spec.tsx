...
jest.mock('@/features/report/components/StatusPieChart', () => ({
  __esModule: true,
  default: () => <div>pie</div>,
}));
jest.mock('@/features/report/components/PriorityBarChart', () => ({
  __esModule: true,
  default: () => <div>bar</div>,
}));
jest.mock('@/features/report/components/MonthlyTasksChart', () => ({
  __esModule: true,
  default: () => <div>area</div>,
}));
