...
jest.mock('@/features/activity/hooks/useActivities', () => ({
  useTaskActivities: () => mockUseActivities(),
}));
      ...
      data: [
        {
          ...
          actor: { id: 'u', fullName: 'Sara' },
          createdAt: '2026-01-01',
        },
      ],
      isLoading: false,
    });
    renderWithProviders(<ActivityTimeline taskId="t1" />, {
      withRouter: false,
    });
...
describe('AttachmentSection', () => {
  it('renders empty and data states', () => {
    ...
    const { unmount } = renderWithProviders(<AttachmentSection taskId="t1" />, {
      withRouter: false,
    });
      ...
      data: [
        {
          ...
          url: 'u',
          taskId: 't1',
          uploadedBy: { id: 'u1', fullName: 'A' },
        },
      ],
      isLoading: false,
    });
    renderWithProviders(<AttachmentSection taskId="t1" />, {
      withRouter: false,
    });
...
describe('CommentSection', () => {
  it('renders empty and data states', () => {
    ...
    const { unmount } = renderWithProviders(<CommentSection taskId="t1" />, {
      withRouter: false,
    });
