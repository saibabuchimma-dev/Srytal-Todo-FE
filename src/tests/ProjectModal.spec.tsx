...
describe('ProjectModal', () => {
  ...
  it('renders create mode', () => {
    renderWithProviders(<ProjectModal opened onClose={jest.fn()} />, {
      withRouter: false,
    });
    expect(
    ...
    expect(
      screen.getByText('Set up a new project and timeline.'),
    ).toBeInTheDocument();
  });
  ...
  it('pre-fills and updates in edit mode', async () => {
    ...
    renderWithProviders(
      <ProjectModal opened onClose={jest.fn()} mode="edit" project={project} />,
      {
        withRouter: false,
      },
    );
  ...
  it('closes via Cancel', async () => {
    ...
    renderWithProviders(<ProjectModal opened onClose={onClose} />, {
      withRouter: false,
    });
